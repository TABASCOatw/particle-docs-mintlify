...
Additionally, specific configurations can be set within `connect()` to customize the login experience beyond [frontend customizations](/guides/customization/appearance/auth).
